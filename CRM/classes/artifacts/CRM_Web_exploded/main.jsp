	...
	<table style="padding: 4px" width="100%">
		<tr>
			<td width="50%" style="padding-left: 40px">
				<img alt="logo" src="${pageContext.request.contextPath}/images/blogo.jpg" width="190" height="40"  >
			</td>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		<div title="家属意愿管理" data-options="selected:true,iconCls:'icon-yxgl'" style="padding: 10px">
			<a href="javascript:openTab('亲属意向信息','saleChanceManage.jsp','icon-yxjhgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-yxjhgl'" style="width: 150px">营销机会管理</a>
			<a href="javascript:openTab('家属意向计划','cusdevplanManage.jsp','icon-khkfjh')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-khkfjh'" style="width: 150px">客户开发计划</a>
		</div>
...
<div region="south" style="height: 25px;padding: 5px" align="center">
	版本所有 leoSanQing <a href="http://www.github/leosanqing" target="_blank">http://www.github/leosanqing</a>(2018)
</div>
